...
public class YiAnNodeConstants {
    ...
    public static final String RecipeContent = "RecipeContent";
    public static final String RecipeComposition = "RecipeComposition";
    public static final String RecipeAbbreviation = "RecipeAbbreviation";
    public static final String RecipeHeader = "RecipeHeader";
    public static final String RecipeComment = "RecipeComment";
    public static final String Herb = "Herb";

    // map to RecipeComposition
